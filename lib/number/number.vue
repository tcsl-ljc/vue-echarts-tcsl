<template>
  <div class="farther" :class="parentClass" v-loading="loading">
    ...
    <div style="height:calc(100% - 15px);">
      <div class="number" ref="chartTemplate" :id="specialId" style="height:100%;">
        <div
    ...
    initChart() {
      ...
      const interval = setInterval(_ => {
        if (index < maxChangeTimes) {
          this.numbers = fmoney(
            this.getRandomNum(numbers, decimalCount),
            decimalCount,
            true
          );
          index++;
...
.number-orange {
  ...
  $border-image: "../../src/assets/static/chart/number_orange.png";
...
.number-blue {
  $font-color: #65e3ff;
  $transation-color: #ff612a;
  $border-image: "../../src/assets/static/chart/number_blue.png";
  @include number-class($border-image, $font-color);
}
.number-purple {
  $font-color: #ffffff;
  $transation-color: #ff612a;
  $border-image: "../../src/assets/static/chart/number_purple.png";
  @include number-class($border-image, $font-color);
}
</style>
